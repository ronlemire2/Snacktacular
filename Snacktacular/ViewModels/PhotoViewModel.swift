...
class PhotoViewModel {
    ...
    static func saveImage(spot: Spot, photo: Photo, data: Data) async {
        ...
        metadata.contentType = "image/jpeg"  // will allow mage to be viewed in the browser from Firestore console
        ...
        do {
            ...
            // Now that photo file is saved to Storage, save a Photo to the spot.id's "photos" collection
